...
const mockStudentData = [
    {
        ...
        subjects: { mathematics: 89, science: 85, computer: 87 },
    ...
    },
    {
        ...
        subjects: { mathematics: 94, science: 90, computer: 92 },
    ...
    },
    {
        ...
        subjects: { mathematics: 82, science: 75, computer: 77 },
    ...
    },
    {
        ...
        subjects: { mathematics: 96, science: 94, computer: 95 },
    ...
    },
    {
        ...
        subjects: { mathematics: 75, science: 71, computer: 73 },
    ...
    },
    {
        ...
        subjects: { mathematics: 90, science: 86, computer: 88 },
...
const mockQuizData = [
    ...
    {
        id: 3, title: "Basic Programming", subject: "Computer Science", class: 11,
    ...
    if (userType === 'teacher') {
        ...
        subjectsGrid.innerHTML = `
            ...
            <div class="subject-card analytics-card" style="--subject-color: #047857;">
                <div class="subject-content">
                    <div class="subject-icon">💻</div>
                    <h3>Computer Science Analytics</h3>
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject" onclick="showSubjectAnalytics('computer')">View Analytics</button>
                </div>
            </div>
            ...
            <div class="subject-card analytics-card" style="--subject-color: #065f46;">
                <div class="subject-content">
                    <div class="subject-icon">🧠</div>
                    <h3>Critical Thinking Analytics</h3>
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject" onclick="showSubjectAnalytics('critical')">View Analytics</button>
                </div>
            </div>
        ...
        subjectsGrid.innerHTML = `
            <div class="subject-card" style="--subject-color: #10B981;">
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject" onclick="window.location.href='../math/math-fp.html'">Start Learning</button>
                </div>
            </div>
            ...
            <div class="subject-card" style="--subject-color: #059669;">
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject" onclick="window.location.href='../science/science-fp.html'">Start Learning</button>
                </div>
            </div>
            ...
            <div class="subject-card" style="--subject-color: #047857;">
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject" onclick="alert('Critical Thinking games coming soon!')">Start Learning</button>
                </div>
            </div>
            ...
            <div class="subject-card" style="--subject-color: #065f46;">
                ...
                <div class="subject-button-container">
                    <button class="btn btn--primary btn--subject">Start Learning</button>
                </div>
            </div>
        `;
    }
...
function createSubjectScoresChart() {
    ...
    try {
        subjectScoresChart = new Chart(ctx, {
            type: 'radar',
            data: {
                labels: ['Mathematics', 'Science', 'Computer Science', 'Critical Thinking'],
                datasets: [{
                    label: 'Class Average',
                    data: [82, 79, 85, 77],
                    borderColor: '#10B981',
...
function navigateToSubject(subject) {
  ...
  setTimeout(() => {
    ...
    if (subject === 'math') {
      window.location.href = 'math/math-fp.html';
    } else if (subject === 'science') {
      window.location.href = 'science/science-fp.html';
    } else {
